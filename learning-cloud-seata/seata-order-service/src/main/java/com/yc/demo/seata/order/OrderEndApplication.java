package com.yc.demo.seata.order;
...
public class OrderEndApplication implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(OrderEndApplication.class);
