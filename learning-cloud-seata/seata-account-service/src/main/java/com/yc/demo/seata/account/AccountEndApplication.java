package com.yc.demo.seata.account;
...
public class AccountEndApplication implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(AccountEndApplication.class);
